codeunit 50343 TlyCheckCreditLimit
{
    ...
    //     // Message('%1 bill to', SalesHeader."Bill-to Customer No.");
    ...
    //         Message('%1 %2 is warning sell', Customer."No.", Customer."Credit Warnings");
    //         if Customer."Credit Warnings" = Customer."Credit Warnings"::"Hold All" then SalesHeader."On Hold" := 'CR'; //Message('nice hold');
    //     end else begin
    //         // message('here2');
    //         Customer.Get(SalesHeader."Bill-to Customer No.");
    //         Message('%1 %2 is warning nill', Customer."No.", Customer."Credit Warnings");
    //         if Customer."Credit Warnings" = Customer."Credit Warnings"::"Hold All" then SalesHeader."On Hold" := 'CR'; //Message('nice hold');
    //         // SalesHeader.Modify(true);
    //     end;
    //     // SalesHeader.Modify(true);
    //     // message('%1 order no chkec 1', SalesHeader."No.");
    //     // Message('%1 %2 is warning', Customer."No.", Customer."Credit Warnings");

    //     // if Customer."Credit Warnings" = Customer."Credit Warnings"::"No Hold" then CreditLimitExceeded := false;

    //     // if Customer."Credit Warnings" = Customer."Credit Warnings"::"Hold All" then SalesHeader."On Hold" := 'CR'; //Message('nice hold');
    //     // CreditLimitExceeded := true;

    //     // message('%1 order no check 2', SalesHeader."No.");
    // end;
    ...
    //     // Message('%1 is warning', Customer."Credit Warnings");

    //     if Customer."Credit Warnings" = Customer."Credit Warnings"::"No Hold" then Result := false;
