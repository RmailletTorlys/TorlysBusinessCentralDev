tableextension 50113 TlySalesInvoiceLine extends "Sales Invoice Line"
{
    fields
    {
        ...
        field(50030; "Salesperson Code 2"; Code[20])
        {
            ...
            Editable = false;
            FieldClass = FlowField;
            CalcFormula = lookup("Sales Invoice Header"."Salesperson Code 2" where("No." = field("Document No.")));
        }
