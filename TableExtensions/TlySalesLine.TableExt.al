tableextension 50037 TlySalesLine extends "Sales Line"
{
    fields
    {
        ...
        field(50032; "Salesperson Commission"; Decimal)
        {
            ...
            Editable = false;
            FieldClass = FlowField;
            CalcFormula = lookup("Sales Header"."Salesperson Commission" where("No." = field("Document No.")));
        }
        field(50033; "Salesperson Commission 2"; Decimal)
        {
            ...
            Editable = false;
            FieldClass = FlowField;
            CalcFormula = lookup("Sales Header"."Salesperson Commission 2" where("No." = field("Document No.")));
        }
        field(50034; "Salesperson Commission 3"; Decimal)
        {
            ...
            Editable = false;
            FieldClass = FlowField;
            CalcFormula = lookup("Sales Header"."Salesperson Commission 3" where("No." = field("Document No.")));
        }
        ...
        modify("No.")
        {
            ...
            begin
                ...
                //the issue that is happening here is when the ship-to is changed and the lines are deleted and re-added, it also re-adds the comments, 
