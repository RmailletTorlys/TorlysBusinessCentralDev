        ...
        addfirst("&Line")
        {
            ...
            action(ItemAccessories)
            {
                ...
                var
                    ...
                    LineNo: Integer;
                    TlyPriceListSalesTriggers: Codeunit TlyPriceListSalesTriggers;
                begin
                    ...
                    TlyPriceListSalesTriggers.UpdateUnitPrice(SalesLine); //this references custom code, dont love it, but it works
                    SalesLine.Insert;
                end;
            }
