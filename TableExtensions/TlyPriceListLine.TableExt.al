tableextension 57001 TlyPriceListLine extends "Price List Line"
{
    fields
    {
        ...
        field(50005; "Full Pallet Price Tier"; Code[20])
        {
            ...
            Editable = false;
            FieldClass = FlowField;
            CalcFormula = lookup("Price List Line"."Price List Code" where("Product No." = field("Product No."), "Unit Price" = field("Stocking Pallet Price"), "Price List Code" = filter('TIER*')));
        }
    }
}