    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                part(salesShipmentLines; "TlySalesShipmentLines")
                {
                    Caption = 'Lines';
                ...
                field(tagName; Rec."Tag Name")
                {
                    Caption = 'Tag Name';
                }

                field(temporaryHold; Rec."Temporary Hold")
                {
                    Caption = 'Temporary Hold';
                }

                field(originalInvoiceNo; Rec."Original Invoice No.")
                {
                    Caption = 'Original Invoice No.';
                }

                field(rebillInvoiceNo; Rec."Rebill Invoice No.")
                {
                ...
                field(outstandingQty; Rec."Outstanding Quantity")
                {
                    Caption = 'Outstanding Qty. to Ship';
                }

                field(bolNo; Rec."BOL No.")
                {
                    Caption = 'BOL No.';
                }
                ...
                field(putAwayDate; Rec."Put Away Date")
                {
