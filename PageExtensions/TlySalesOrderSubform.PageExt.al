        ...
        addfirst("&Line")
        {
            ...
            action(ItemAccessories)
            {
                ...
                var
                    ...
                    LineNo: Integer;
                    TlySalesPriceListTriggers: Codeunit TlySalesPriceListTriggers;
                begin
                    ...
                    TlySalesPriceListTriggers.UpdateUnitPrice(SalesLine); //this references custom code, dont love it, but it works
                    SalesLine.Insert;
                end;
            }
