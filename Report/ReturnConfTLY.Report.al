report 50035 "Return Conf TLY"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Local/Sales/Document/ReturnConfTLY.rdlc';
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem(SalesLine; "Integer")
                    {
                        ...
                        column(TempSalesLine__Unit_of_Measure_; TempSalesLine."Unit of Measure Code")
                        {
                        }
                        ...
                        column(QtyCase; TempSalesLine."Quantity Case")
                        {

                        }
                        column(QtyPallet; TempSalesLine."Quantity Pallet")
                        {
