tableextension 50111 TlySalesShipmentLine extends "Sales Shipment Line"
{
    fields
    {
        ...
        field(50032; "Salesperson Commission"; Decimal)
        {
            ...
            Editable = false;
            FieldClass = FlowField;
            CalcFormula = lookup("Sales Shipment Header"."Salesperson Commission" where("No." = field("Document No.")));
        }
        field(50033; "Salesperson Commission 2"; Decimal)
        {
            ...
            Editable = false;
            FieldClass = FlowField;
            CalcFormula = lookup("Sales Shipment Header"."Salesperson Commission 2" where("No." = field("Document No.")));
        }
        field(50034; "Salesperson Commission 3"; Decimal)
        {
            ...
            Editable = false;
            FieldClass = FlowField;
            CalcFormula = lookup("Sales Shipment Header"."Salesperson Commission 3" where("No." = field("Document No.")));
        }
        ...
        field(50047; "Order Type"; Code[20])
        {
            ...
            Editable = false;
            FieldClass = FlowField;
            CalcFormula = lookup("Sales Shipment Header"."Order Type" where("No." = field("Document No.")));
        }
    }
