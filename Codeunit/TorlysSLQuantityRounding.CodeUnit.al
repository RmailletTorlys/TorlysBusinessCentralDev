codeunit 50002 "Torlys SL Quantity Rounding"
{
    ...
    procedure OnValidateQtyToShipSO(var Rec: Record "Sales Line"; xRec: Record "Sales Line")
    begin
    ...
    procedure OnValidateQtyToReceiveRO(var Rec: Record "Sales Line"; xRec: Record "Sales Line")
    begin
    ...
    begin
        if Rec.Type = Rec.Type::Item then begin //only run check for items
            ...
            Rec.VALIDATE("Return Qty. to Receive", ((QtyPerPallet * Rec."Return Qty. to Receive Pallet") + (QtyPerCase * Rec."Return Qty. to Receive Case")) / Rec."Qty. per Unit of Measure");
        end;
    end;
