...
report 50043 "Open Purchase - Credit Memo"
{
    DefaultLayout = Word;
    WordLayout = './Purchases/OpenPurchaseCreditMemo.docx';
        ...
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(PaytoVendNo_PurchCrMemoHeader; "Purchase Header"."Pay-to Vendor No.")
                    {
                    }
                    column(DocDate04_PurchCrMemoHeader; Format("Purchase Header"."Document Date", 0, 4))
                    {
                    }
                    column(VATNoTxt; VATNoText)
                    {
                    }
                    column(VATRegNo_PurchCrMemoHeader; "Purchase Header"."VAT Registration No.")
                    {
                    }
                    column(No1_PurchCrMemoHeader; "Purchase Header"."No.")
                    {
                    }
                    ...
                    column(YourRef_PurchCrMemoHeader; "Purchase Header"."Your Reference")
                    {
                    }
                    ...
                    column(PostingDate_PurchCrMemoHeader; Format("Purchase Header"."Posting Date"))
                    {
                    }
                    column(PricesIncludingVAT_PurchCrMemoHeader; "Purchase Header"."Prices Including VAT")
                    {
                    }
                    column(BuyfrmVendNo_PurchCrMemoHeader; "Purchase Header"."Buy-from Vendor No.")
                    {
                    }
                    // column(ReturnOrderNo_PurchCrMemoHeader; "Purchase Header"."Return Order No.")
                    // {
                    // }
                    ...
                    column(PricesIncVAT_PurchCrMemoHeader; Format("Purchase header"."Prices Including VAT"))
                    {
                    }
                    ...
                    column(PaytoVendNo_PurchCrMemoHeaderCaption; "Purchase header".FieldCaption("Pay-to Vendor No."))
                    {
                    }
                    column(PricesIncludingVAT_PurchCrMemoHeaderCaption; "Purchase header".FieldCaption("Prices Including VAT"))
                    {
                    }
                    column(BuyfrmVendNo_PurchCrMemoHeaderCaption; "Purchase header".FieldCaption("Buy-from Vendor No."))
                    {
                    }
                    ...
                    dataitem("Purchase Line"; "Purchase Line")
                    {
                        ...
                        column(Type_PurchCrMemoLine; Format("Purchase Line".Type, 0, 2))
                        {
                        }
                        column(VATBasDisc_PurchCrMemoLine; "Purchase header"."VAT Base Discount %")
                        {
                        }
                ...
                begin
                    if not IsReportInPreviewMode() then
                        CODEUNIT.Run(CODEUNIT::"PurchCrMemo-Printed", "Purchase Header");
                end;
            ...
            begin
                ...
                PricesIncludingVAT := Format("Purchase Header"."Prices Including VAT");
            ...
            if "Purchase Header".FindSet() then
                repeat
                    SegManagement.LogDocument(
                      16, "Purchase Header"."No.", 0, 0, DATABASE::Vendor, "Purchase Header"."Buy-from Vendor No.",
...
#pragma warning restore AA0074
    ...
    // begin
    //     if "Purchase Header"."Prepayment Credit Memo" then
    //         exit(Text011);
    //     exit(Text005);
    // end;
    ...
    local procedure FormatAddressFields(var PurchCrMemoHdr: Record "Purchase Header")
    begin
        FormatAddr.GetCompanyAddr(PurchCrMemoHdr."Responsibility Center", RespCenter, CompanyInfo, CompanyAddr);
        FormatAddr.PurchHeaderPayTo(VendAddr, PurchCrMemoHdr);
        FormatAddr.PurchHeaderShipTo(ShipToAddr, PurchCrMemoHdr);
    end;

    local procedure FormatDocumentFields(PurchCrMemoHdr: Record "Purchase Header")
    begin
    ...
    [IntegrationEvent(true, false)]
    local procedure OnAfterPostDataItem(var PurchCrMemoHdr: Record "Purchase Header")
    begin
    end;
}
