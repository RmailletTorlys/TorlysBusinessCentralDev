tableextension 56661 TlyReturnReceiptLine extends "Return Receipt Line"
{
    fields
    {
        ...
        field(50029; "Salesperson Code"; Code[20])
        {
            ...
            CalcFormula = lookup("Return Receipt Header"."Salesperson Code" where("No." = field("Document No.")));
        }
        field(50030; "Salesperson Code 2"; Code[20])
        {
            ...
            Editable = false;
            FieldClass = FlowField;
            CalcFormula = lookup("Return Receipt Header"."Salesperson Code 2" where("No." = field("Document No.")));
        }
        field(50031; "Salesperson Code 3"; Code[20])
        {
            ...
            Editable = false;
            FieldClass = FlowField;
            CalcFormula = lookup("Return Receipt Header"."Salesperson Code 3" where("No." = field("Document No.")));
        }
        field(50032; "Salesperson Commission"; Decimal)
        {
            ...
            Editable = false;
            FieldClass = FlowField;
            CalcFormula = lookup("Return Receipt Header"."Salesperson Commission" where("No." = field("Document No.")));
        }
        field(50033; "Salesperson Commission 2"; Decimal)
        {
            ...
            Editable = false;
            FieldClass = FlowField;
            CalcFormula = lookup("Return Receipt Header"."Salesperson Commission 2" where("No." = field("Document No.")));
        }
        field(50034; "Salesperson Commission 3"; Decimal)
        {
            ...
            Editable = false;
            FieldClass = FlowField;
            CalcFormula = lookup("Return Receipt Header"."Salesperson Commission 3" where("No." = field("Document No.")));
        }
        ...
        field(50042; "Order Date"; Date)
        {
            ...
            Editable = false;
            FieldClass = FlowField;
            CalcFormula = lookup("Return Receipt Header"."Order Date" where("No." = field("Document No.")));
        }
