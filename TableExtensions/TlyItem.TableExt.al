tableextension 50027 TlyItem extends Item
{
    fields
    {
        ...
        field(50032; "Qty. on Hand (CLAIMSTOR)"; Decimal)
        {
            ...
            CalcFormula = sum("Item Ledger Entry".Quantity where("Item No." = field("No."),
                                                                  "Global Dimension 1 Code" = field("Global Dimension 1 Filter"),
                                                                  "Global Dimension 2 Code" = field("Global Dimension 2 Filter"),
                                                                  "Location Code" = const('CLAIMS TOR'),
                                                                  "Drop Shipment" = field("Drop Shipment Filter"),
                                                                  "Variant Code" = field("Variant Filter"),
                                                                  "Lot No." = field("Lot No. Filter"),
                                                                  "Serial No." = field("Serial No. Filter"),
        ...
        field(50033; "Qty. on Hand (CLAIMSCAL)"; Decimal)
        {
            ...
            CalcFormula = sum("Item Ledger Entry".Quantity where("Item No." = field("No."),
                                                                  "Global Dimension 1 Code" = field("Global Dimension 1 Filter"),
                                                                  "Global Dimension 2 Code" = field("Global Dimension 2 Filter"),
                                                                  "Location Code" = const('CLAIMS CAL'),
                                                                  "Drop Shipment" = field("Drop Shipment Filter"),
                                                                  "Variant Code" = field("Variant Filter"),
                                                                  "Lot No." = field("Lot No. Filter"),
                                                                  "Serial No." = field("Serial No. Filter"),
        ...
        field(50040; "Qty. on Hand (SCANGLOBAL)"; Decimal)
        {
            ...
            CalcFormula = sum("Item Ledger Entry".Quantity where("Item No." = field("No."),
                                                                  "Global Dimension 1 Code" = field("Global Dimension 1 Filter"),
                                                                  "Global Dimension 2 Code" = field("Global Dimension 2 Filter"),
                                                                  "Location Code" = const('SCANGLOBAL'),
                                                                  "Drop Shipment" = field("Drop Shipment Filter"),
                                                                  "Variant Code" = field("Variant Filter"),
                                                                  "Lot No." = field("Lot No. Filter"),
                                                                  "Serial No." = field("Serial No. Filter"),
        ...
        field(50043; "VMI Stock"; Decimal)
        {
            ...
            Editable = false;
            ObsoleteState = Removed;
            ObsoleteReason = 'TLY-SD - 07/15/2026 - needed to change field type and it would not let me, so just disco as no one asks about it.';
        }
        ...
        field(50065; "Purchases (Qty.) - 90D"; Decimal)
        {
