codeunit 50416 TorlysCreditHold
{
    ...
    begin
        ...
        Message('Order = %1\Customer = %2\Amount = %3\Previous Credit Status = %4\Current Credit Status = %5', Rec."No.", Rec."Sell-to Customer No.", Rec."Amount Including VAT", xRec."On Hold", Rec."On Hold");
    end;
