codeunit 57002 TlyPriceSourceSalesPriceCode implements "Price Source"
{
    var
    ...
    begin
        ...
        if Page.RunModal(Page::TlySalesPriceCodeList, SalesPriceCode) = ACTION::LookupOK then begin
